/**
 * Demo / mock data for the admin dashboard UI.
 *
 * These users and roles are **placeholder data** shown while the backend
 * authorization module is being developed. When the real API is ready,
 * remove this file and replace with live API calls.
 *
 * @see {@link https://github.com/anomalyco/opencode/issues/42}
 */
